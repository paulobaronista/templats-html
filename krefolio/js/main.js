  ...
  /* ========================================================================
   ...
   ========================================================================== */
    ...
    $("#contact-form").submit(function (e) {
        ...
        if (isValidEmail(email) && (description.length > 1) && (projectName.length > 1) && (firstName.length > 1)) {
            $.ajax({
                type: "POST",
                url: "sendmail.php",
                data: dataString,
                success: function () {
                    notie.alert(1, 'Sua mensagem foi enviada com sucesso.', 2.5);
                    $("#contact-form").val("");
                    /*$(location).attr('href', 'http://digimobi.com.br/obrigado.html');*/
                }
            });
        } else {
            notie.alert(3, 'Email não pode ser enviado. Por favor, preencha todos os campos.', 2.5);
        }
